        ...
        <div class="container-xxl position-relative p-0">
            <nav class="navbar navbar-expand-lg navbar-dark bg-dark px-4 px-lg-5 py-3 py-lg-0">
                <a href="/" class="navbar-brand p-0">
                    <h1 class="text-primary m-0"><i class="fa fa-coffee me-3"></i>Coffee Land</h1>
...
// show active if current page is home
// show active if current page is home
?>if ($title == 'Home | Coffee Land') {
                            echo 'active';
                        } ?>">Home</a>


                        <a href="/kedai" class="nav-item nav-link <?php
// show active if current page is kedai
// show active if current page is kedai
?>if ($title == 'Kedai | Coffee Land') {
                            echo 'active';
                        } ?>">Cafes</a>                       
                        <a href="/contact" class="nav-item nav-link <?php
// show active if current page is kedai
// show active if current page is kedai
?>if ($title == 'Contact | Coffee Land') {
                            echo 'active';
                        } ?>">Contact</a>                                                                    
                    </div>
                    <form id="search" action="/carikedai" method="POST">
                        <input class="form-control col-sm-1" type="search" placeholder="Search" name="search" aria-label="Search">
                    </form>
                    <button class="btn btn-primary" form="search" type="submit"><i class="fas fa-search"></i></button>
