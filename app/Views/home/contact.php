                ...
                <div class="container text-center my-5 pt-5 pb-4">
                    ...
                    <span class="subheading"><?php
                                                    if (session()->getFlashdata('pesan') ) {
                                                        echo  '<div class="alert alert-primary" role="alert">' . session()->getFlashdata('pesan') . '</div>';} 
                                                    ?></span>
                </div>
            </div>
        </div>
                                    ...
                                    <div class="col-12">
                                        <div class="form-floating">
                                            <select class="form-select" aria-label="Default select example" name="subject">
                                                ...
                                                <option value="Asking Question">Asking Question</option>
                                                <option value="Partnership With Coffee Land">Partnership With Coffee Land</option>
                                                <option value="Editing Data Cafe">Editing Data Cafe</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-12">
